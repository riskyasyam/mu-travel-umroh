        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            <div class="self-center">
                ...
                <div class="grid grid-cols-2 gap-6">
                    <!-- Head Office -->
                    <div>
                        <h4 class="text-xl font-semibold text-gray-800">Head Office</h4>
                        <p class="text-xl text-gray-600">
                            Jalan Hayam Wuruk No.8 Sempusari, Kaliwates, Jember, Jawa Timur
                        </p>
                    </div>
                    <!-- Kantor Administrasi -->
                    <div>
                        <h4 class="text-xl font-semibold text-gray-800">Kantor Administrasi</h4>
                        <p class="text-xl text-gray-600">
                            Dusun Maduran RT 01 RW 02, Tutul - Balung, Kabupaten Jember
                        </p>
                    </div>
                </div>
            </div>
