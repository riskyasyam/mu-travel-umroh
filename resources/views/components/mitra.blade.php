        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center bg-white shadow-lg rounded-lg p-8 relative z-10 max-w-4xl">
            ...
            <div>
                ...
                <p class="text-gray-700 text-center md:text-left mb-6">
                    ...
                    Ingin merasakan pengalaman umroh yang NYATA(Nyaman, Amanah, Terjangkau)? 
                ...
                <div class="bg-green-500 text-white font-semibold text-center md:text-left py-2 px-4 mt-6 rounded-md">
                    <a href="https://wa.me/081234550234">Whatsapp Sekarang</a>
                </div>
            </div>

            <!-- Kolom Gambar -->
            <div>
                <img src="/assets/images/mama.png" alt="Tour Leader" class="w-full h-auto rounded-lg shadow-md">
            </div>
        </div>
    </div>
</section>
