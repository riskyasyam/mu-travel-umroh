<section class="py-16 bg-white">
    <div class="container mx-auto flex flex-col md:flex-row items-center">
        ...
        <!-- Kolom Teks -->
        <div class="w-full md:w-1/2 mt-10 md:mt-0 md:pl-10">
            <!-- Selamat Datang dan Nama Travel -->
            <div class="mb-6">
                <h2 class="text-2xl font-semibold text-gray-800">Selamat Datang</h2>
                <h1 class="text-5xl font-extrabold text-gray-900 font-elmessiri mt-4">MU Tour & Travel</h1>
            </div>
            <!-- Gambar Elemen -->
            <div class="w-full md:w-1/2 flex justify-center">
