<section id="dokumentasi" class="py-5 bg-white">
    <div id="animation-carousel" class="relative w-full max-w-4xl mx-auto px-4" data-carousel="static">
        ...
        <div id="indicators-carousel" class="relative w-full" data-carousel="static">
            <div class="relative h-[300px] md:h-[500px] overflow-hidden rounded-lg">
                @foreach($dokumentasi as $index => $item)
                    <div class="{{ $index == 0 ? 'block' : 'hidden' }} duration-700 ease-in-out" data-carousel-item>
                        <img src="{{ asset('storage/' . $item->url_foto) }}"
                            class="absolute block w-full h-full object-cover rounded-lg shadow-lg -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
